...
<template>
  <p>historique des commandes passées</p>
  <div class="bg-white">
              ...
              <tr v-for="product in order.products" :key="product.id">
                <td class="py-6 pr-8">
                  <div class="flex items-center">
                    <img src="/src/assets/img/quino-al-vBxlL1xpSdc-unsplash.jpg" :alt="product.imageAlt" class="w-16 h-16 object-center object-cover rounded mr-6" />
                    <div>
